    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-content">
            <ul class="pc-navbar">
                ...
                <li class="pc-item">
                    <a href="{{url('/Admin_Admin')}}" class="pc-link "><span class="pc-micon"><i data-feather="home"></i></span><span class="pc-mtext">Trang chủ</span></a>
                </li>
                <li class="pc-item pc-caption">
                    
                </li>
                <li class="pc-item">
                    <a href="{{route('categories.index')}}" class="pc-link "><span class="pc-micon"><i data-feather="book"></i></span><span class="pc-mtext">Danh Mục Sản Phẩm</span></a>
                </li>
                <li class="pc-item">
                    <a href="{{route('menus.index')}}" class="pc-link "><span class="pc-micon"><i data-feather="menu"></i></span><span class="pc-mtext">Menus</span></a>
                </li>
            ...
            <div class="p-3 m-4 bg-secondary rounded">
                <div class="text-center text-white">
                    ...
                    <h6 class="mt-3 text-white">Download Pro</h6>
                    <p>Getting more features with pro version</p>
                    <a href="https://1.envato.market/VGznk" target="_blank" class="btn btn-dark btn-sm text-white m-0">Upgrade Now</a>
                </div>
            </div>
        </div>
    </div>
